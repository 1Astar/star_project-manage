...
const ENV_INDEX = [
  ...
  { key: "PUSHPLUS_TOKEN", purpose: "PushPlus 微信推送（验收提醒 + 每日工作台日报）", where: "服务端环境变量" },
  { key: "NEXT_PUBLIC_APP_URL", purpose: "推送正文里的可点链接根地址（如 https://pm.starry-studio.cn）", where: "可选；缺省回落 pm.starry-studio.cn" },
