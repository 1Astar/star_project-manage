    ...
    >
      <div className="grid gap-6 lg:grid-cols-3">
        <section className="card p-5">
          <h2 className="font-semibold">进行中任务</h2>
          <div className="mt-3 space-y-2">
            {pendingTasks.slice(0, 20).map((t) => {
              const project = projects.find((p) =>
                pendingAcceptance.some((r) => r.project_id === p.id)
              );
              return (
        ...
        <section className="card p-5">
          <h2 className="font-semibold">待产品验收</h2>
          <div className="mt-3 space-y-2">
            {pendingAcceptance.map((r) => {
              ...
              return (
                <Link
                  ...
                  className="block rounded-lg border border-slate-100 p-2 text-sm hover:border-blue-200"
                >
        ...
        <section className="card p-5">
          <h2 className="font-semibold">未读通知</h2>
          <div className="mt-3 space-y-2">
