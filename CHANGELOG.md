...
- **协作节奏**：要求不清先细问再做；计划/需求直接写 PM，不写 spec；发版前测试对照**初始要求**再跑 tsc/单测/冒烟
- **Skill**：`star-pm-write-release` 补充「做完可发版」、发版前测试门禁、有则写之无则跳过  
- 说明：远程曾误打 `v1.10.32` 指向旧 commit，本版以 `v1.10.33` 为准

## v1.10.32 · 2026-07-28

- （跳过）远程 tag 误指；内容并入 v1.10.33
