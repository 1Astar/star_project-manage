...
- **协作节奏**（正式 tag）：要求不清先细问再做；计划/需求直接写 PM，不写 spec；发版前测试对照**初始要求**
- **Skill** 门禁：做完可发版；有则写之无则跳过  
- 说明：`v1.10.32`/`v1.10.33` 远程 tag 曾错位，**以本版为准**

## v1.10.33 · 2026-07-28

- （中间 tag）内容并入 v1.10.34

## v1.10.32 · 2026-07-28

- （跳过）远程 tag 误指旧 commit
