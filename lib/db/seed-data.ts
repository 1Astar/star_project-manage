  ...
  return {
    projects: [
      ...
      },
      {
        ...
        name: "AI 控制器",
        slug: "ai-controller",
        description: "元井 AI 控制器：设备控制、归属迁移、下控体验与分期优化（与水泵/宠物分线）",
        parent_id: null,
        pool_tag_options: ["硬件", "软件", "体验"],
        created_at: SEED_TIME,
        ...emptyProjectGitFields(),
      },
      {
        ...
        name: "元井水泵控制系统",
        slug: "yuanjing-pump",
        description: "水泵/泵组智能运维：小程序远程管控 + Web 后台规模化交付（元井/YOKING）",
        parent_id: controllerProjectId,
        pool_tag_options: ["硬件", "软件", "体验"],
        created_at: SEED_TIME,
        ...emptyProjectGitFields(),
      },
